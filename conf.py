...
from sphinx_gallery.sorting import ExplicitOrder, FileNameSortKey, FunctionSortKey
...
# For sphinx_gallery.__version__ >= '0.16.0'
# gallery_order_sectionorder = 'gallery_order.sectionorder'
# gallery_order_subsectionorder = 'gallery_order.subsectionorder'
from gallery_order import (
...
sphinx_gallery_conf = {
    ...
    # "minigallery_sort_order": "sphinxext.script_sorter",
    # "minigallery_sort_order": FunctionSortKey(lambda fname: fname.split()[1] if len(fname.split())>1 else fname),
