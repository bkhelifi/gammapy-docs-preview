...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    -   name: ITi2SehN
        ...
        spatial:
            ...
            -   name: lat_0
                value: -0.0625
                unit: deg
            filename: /home/khelifi/MesProgrammes/gammapy-data/fermi-3fhl-gc/gll_iem_v06_gc.fits.gz
            normalize: false
            unit: 1 / (cm2 MeV s sr)
    -   name: my-source-copy
        type: SkyModel
    ...
    metadata:
        ...
        date: '2024-10-07T16:14:36.981983'
        origin: null
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Parameter(name='index', value=2.3, factor=2.3, scale=1.0, unit=Unit(dimensionless), min=1.0, max=5.0, frozen=False, prior=None, id=0x76355c0a8710)
    Parameter(name='index', value=2.3, factor=2.3, scale=1.0, unit=Unit(dimensionless), min=1.0, max=5.0, frozen=False, prior=None, id=0x76355c0a8710)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    metadata:
        creator: Gammapy 1.3.dev1108+g3132bb30e.d20241007
        date: '2024-10-07T16:14:37.080601'
        origin: null
