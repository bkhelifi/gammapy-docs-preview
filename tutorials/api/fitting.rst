...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Gammapy package:
            ...
            version                : 1.3.dev1110+ga6ff45c25.d20241008 
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/home/khelifi/MesProgrammes/gammapy/examples/tutorials/api/fitting.py", line 146, in <module>
        results_simplex = fit_sherpa.run(datasets)
                          ^^^^^^^^^^^^^^^^^^^^^^^^
      File "/home/khelifi/MesProgrammes/gammapy/.tox/build_docs/lib/python3.11/site-packages/gammapy/modeling/fit.py", line 170, in run
        optimize_result = self.optimize(datasets=datasets)
                          ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      File "/home/khelifi/MesProgrammes/gammapy/.tox/build_docs/lib/python3.11/site-packages/gammapy/modeling/fit.py", line 219, in optimize
        factors, info, optimizer = compute(
                                   ^^^^^^^^
      File "/home/khelifi/MesProgrammes/gammapy/.tox/build_docs/lib/python3.11/site-packages/gammapy/modeling/sherpa.py", line 50, in optimize_sherpa
        optimizer = get_sherpa_optimizer(method)
                    ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      File "/home/khelifi/MesProgrammes/gammapy/.tox/build_docs/lib/python3.11/site-packages/gammapy/modeling/sherpa.py", line 9, in get_sherpa_optimizer
